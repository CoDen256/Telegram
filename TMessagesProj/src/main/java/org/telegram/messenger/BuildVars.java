...
public class BuildVars {
    ...
    public static int APP_ID = 497206;
    public static String APP_HASH = "033d85c1eba680fc64a14127a382a448";
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "org.telegram.messenger.willpowerless".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }
